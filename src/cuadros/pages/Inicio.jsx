...
export const Inicio = () => {
  return (
    <>
      <div className="container mx-auto px-0 mt-xl-4 mt-sm-0">
        <div className="row d-flex align-items-center justify-content-start">
          ...
          <p className="text-md-start text-center ps-sm-5 firstTittleHome fw-bolder mt-md-0 mt-4">Lo más nuevo</p>
